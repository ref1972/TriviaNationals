...
- By 2026-08-02 the gateway had accepted eight `timed_quiz` messages in total.
  Six were one-per-attempt completion notifications generated by normal tester
  activity; all six have successful Timed Quiz audit events/timestamps and zero
  recorded failures. WordPress remains uncut-over.
